...
class admin1 {
    public static void main(String[] args) {
        ...
        try {
            File fr = new File(
                    "C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\3rd Semester Project\\Project\\patients.txt");
        ...
        try {
            File fr = new File(
                    "C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\3rd Semester Project\\Project\\medicines.txt");
            Scanner s = new Scanner(fr);
            while (s.hasNextLine()) {
                String data = s.nextLine();
        ...
        try {
            File fr = new File(
                    "C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\3rd Semester Project\\Project\\worker.txt");
        ...
        while (opt != 5) {
            ...
            try {
                File fr = new File(
                        "C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\3rd Semester Project\\Project\\doctors.txt");
                Scanner s = new Scanner(fr);
                while (s.hasNextLine()) {
                    String data = s.nextLine();
                    String[] result = data.split(":");
            ...
            if (opt == 1) {
                ...
                while (opt1 != 4) {
                        ...
                        try {
                            ...
                            for (y = 0; y < i; y++) {
                                ...
                                if ((d[y].dname).equals(se)) {
                                    System.out.println(ds + " is available at " + d[y].getAvailability() + " on "
                                            + d[y].getWorkingday());
                                    m = m + 1;
                                    break;
                                }
                    ...
                    // File oldfile=new
                    // File("C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\Project\\doctors.txt");
                    ...
                    // FileReader fr=new
                    // FileReader("C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\Project\\doctors.txt");
                    ...
                    // FileWriter("C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\Project\\doctors.txt",true);
                    // fwrite.write("\n");
                    // fwrite.write(h1+":");
                    // fwrite.write(h2+":");
                    // fwrite.write(h3+":");
            ...
            if (opt == 2) {
                ...
                while (opt2 != 5) {
                    ...
                    if (opt2 == 3) {
                        ...
                        for (int y = 0; y < j; y++) {
                            ...
                            if (hs.equalsIgnoreCase(sid)) {
                                ...
                                System.out.println(
                                        "anaemia--irregular menstrual cycle--stomach pain--fatigue--mood disorders--hormonal imbalance");
                                System.out.println(
                                        "yellow eyes--yellow skin--nausea--swelling of legs--abdominal pain--loss of appetite--fever\n\n");
                    ...
                    if (opt2 == 4) {
                        ...
                        // System.out.println(docname+" is available on"+docname.getWorkingday()+ "at
                        // "+docname.getAvailability());
                        /*
                         * System.out.println("Enter the doctor you want to consult:");
                         * sc.nextLine();
            ...
            if (opt == 3) {
                ...
                /*
                 * File doc1=new
                 * File("C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\Project\\worker.txt");
                 * lq=lq+1;
                 * System.out.println("Enter the name:");
                 * sc.nextLine();
                 * name=sc.nextLine();
                 ...
                 * {
                 * FileWriter fwrite=new FileWriter(
                 * "C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\Project\\worker.txt",true);
                 * fwrite.write("\n");
                ...
                while (opt4 != 5) {
                    if (opt4 == 1) {
                        try {
                            ...
                            FileWriter fwrite = new FileWriter(
                                    "C:\\Users\\swath\\OneDrive\\Desktop\\Swathika\\Project\\medicines.txt", true);
                            fwrite.write("\n");
